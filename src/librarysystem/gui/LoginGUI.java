...
public class LoginGUI extends JPanel {
	...
	public LoginGUI(LibrarySystem librarySystem) {
		...
		/**
		 * Labels used to display information to user in order to notify of actions
		 * performed or data input requirments
		 */
		...
		/**
		 * Textfilds that allow for input from user
		 */
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				if (user == null) {
					JOptionPane.showMessageDialog(librarySystem.getFrame(),
