...
public class eBook extends Material {
	...
	public eBook(String title, String author, String id, int edition, int barcode, MaterialStatus materialStatus, Long takeoutDate) {
		super(title, author, id, edition, barcode, materialStatus, MaterialType.EBOOK, takeoutDate);
	}
}
